...
{try{$('#pin-form').submit(function(e){e.preventDefault();get_order_data($(this).data('order_id'),$(this).find('input').val());});refresh_cart('.cart-data__inner');$('.js--order-form').submit(function(e){e.preventDefault();var form=$(this);if(form.data('token')!==undefined)
